  ...
  return (
    <>
      ...
      <StyledDialog
        open={open}
        onClose={onClose}
        aria-labelledby="view-payroll-dialog-title"
        maxWidth="md"
        fullWidth
      >
        <StyledDialogTitle id="view-payroll-dialog-title">
          ...
          <>
            <ProfileHeader>
              <EmployeeAvatar
                ...
                src={payroll.avatar || "/static/images/avatar/1.jpg"}
              >
                {!payroll.avatar && <Person fontSize="large" />}
              </EmployeeAvatar>
